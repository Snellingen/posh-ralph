...
```powershell
pwsh -File ./ralph.ps1 -PromptFile prompts/default.txt -AllowProfile dev -Iterations 10
```
...
```powershell
pwsh -File ./ralph-once.ps1 -PromptFile prompts/default.txt -AllowProfile dev
```
...
```powershell
pwsh -File ./ralph.ps1 -PromptFile prompts/safe-write-only.txt -AllowProfile locked -Iterations 10
```
...
```powershell
pwsh -File ./ralph.ps1 -PromptFile prompts/wordpress-plugin-agent.txt -PrdFile plans/prd.json -AllowProfile safe -Iterations 10
```
...
```powershell
pwsh -File ./ralph.ps1 -PromptFile prompts/pest-coverage.txt -AllowProfile safe -Iterations 10
```
...
```powershell
pwsh -File ./ralph-once.ps1 -PromptFile prompts/safe-write-only.txt -AllowProfile locked
```
...
```powershell
pwsh -File ./ralph.ps1 -PromptFile prompts/default.txt -AllowProfile dev -DenyTools 'shell(git push)' -Iterations 10
```
